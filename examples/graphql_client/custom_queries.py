...
from .custom_typing_fields import GraphQLField, TranslatableItemUnion, _EntityUnion
...
class Query:
    ...
    def webhook_sample_payload(
        cls, *, eventType: Optional[WebhookSampleEventTypeEnum] = None
    ) -> GraphQLField:
        return GraphQLField(field_name="webhookSamplePayload", eventType=eventType)
    ...
    @classmethod
    def translation(
        cls, *, id: Optional[str] = None, kind: Optional[TranslatableKinds] = None
    ) -> TranslatableItemUnion:
        return TranslatableItemUnion(field_name="translation", id=id, kind=kind)
    ...
    @classmethod
    def gift_card_currencies(cls) -> GraphQLField:
        return GraphQLField(field_name="giftCardCurrencies")
    ...
    @classmethod
    def entities(cls, *, representations: Optional[Any] = None) -> _EntityUnion:
        return _EntityUnion(field_name="_entities", representations=representations)
